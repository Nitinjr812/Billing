...
function ThemeToggle() {
  ...
  return (
    ...
    >
      {isDark ? (
        // Sun icon — dark mode mein dikhega
        ...
        // Moon icon — light mode mein dikhega
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
          stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex" style={{ alignItems: "center", gap: "4px" }}>
        {NAV_ITEMS.filter((n) => n.label !== "Notifications" && n.label !== "Settings").map((item) => {
      ...
      {/* Right — Theme Toggle + Bell + Avatar + Hamburger */}
    ...
    <>
      ...
      >
          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              <button
                ...
                onMouseEnter={(e) => {
                  if (!isActive) { e.currentTarget.style.color = t.textPrimary; e.currentTarget.style.background = t.bgHover; }
                }}
                onMouseLeave={(e) => {
                  if (!isActive) { e.currentTarget.style.color = t.textMuted; e.currentTarget.style.background = "transparent"; }
                }}
              >
        ...
        <div style={{
          ...
          <div>
            <p style={{ fontSize: "13px", fontWeight: 600, color: t.textPrimary, fontFamily: "'Syne', sans-serif" }}>Rajyadu Admin</p>
            <p style={{ fontSize: "11px", color: t.textMuted }}>admin@rajyadu.in</p>
          </div>
        </div>
      </aside>
    </>
